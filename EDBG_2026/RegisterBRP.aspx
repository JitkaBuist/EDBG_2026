<%@ Page Title="Register BRP" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true"
    Inherits="RegisterBRP" EnableEventValidation="false" Codebehind="RegisterBRP.aspx.cs" %>
...
<script>
    function exportToXlsx() {
        ...
        XLSX.writeFile(wb, "RegisterBRP.xlsx"); // Echte XLSX, geen warning
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="heading">
            <span class="title">Register BRP</span>
        </div>
...
<asp:GridView ID="gvBRP" runat="server"
