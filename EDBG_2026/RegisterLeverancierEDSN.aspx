<%@ Page Title="Register Leveranciers EDSN" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true"
    Inherits="RegisterLeverancierEDSN" EnableEventValidation="false" Codebehind="RegisterLeverancierEDSN.aspx.cs" %>
...
<script>
    function exportToXlsx() {
        ...
        XLSX.writeFile(wb, "RegisterLeveranciersEDSN.xlsx"); // Echte XLSX, geen warning
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="heading">
            <span class="title">Register Leverancier</span>
        </div>
...
<asp:GridView ID="gvLeverancierEDSN" runat="server"
