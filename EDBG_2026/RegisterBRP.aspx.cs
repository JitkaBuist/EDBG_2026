...
public partial class RegisterBRP : System.Web.UI.Page

{
    ...
    {
        gvBRP.EditIndex = e.NewEditIndex;
        BindGrid();
    }
    ...
    {
        // Key
        var oldEAN = gvBRP.DataKeys[e.RowIndex].Value.ToString();

        // Nieuwe waarden
        var row = gvBRP.Rows[e.RowIndex];
        string ean = gvBRP.DataKeys[e.RowIndex].Value.ToString();
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            GridViewRow footer = gvBRP.FooterRow;
            ...
            using (var con = new SqlConnection(ConnString))
            using (var cmd = new SqlCommand(@"
                INSERT INTO dbo.RegisterBRP (EAN, Status, Naam, Adres, Email, Datum)
