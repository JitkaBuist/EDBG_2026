<%@ Page Title="Register GDS EDSN" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true"
    Inherits="RegisterGDSEDSN" EnableEventValidation="false" Codebehind="RegisterGDS-EDSN.aspx.cs" %>
...
<script>
    function exportToXlsx() {
        ...
        XLSX.writeFile(wb, "RegisterGDSEDSN.xlsx"); // Echte XLSX, geen warning
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel">
        <div class="heading">
            <span class="title">Register GDS EDSN</span>
        </div>
...
<asp:GridView ID="gvGDSEDSN" runat="server"
