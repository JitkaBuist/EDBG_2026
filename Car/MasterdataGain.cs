...
namespace Energie.Car
{
    public class MasterdataGain
    {
        ...
        public MasterdataGain(nl.Energie.EDSN.MasterdataGain.MasterDataGainResponseEnvelope_PC_PMP portaal_MeteringPoint, int Bericht_ID, Boolean pblnBatchProcess, Int64 SenderEAN)
        {
            ...
            //Todo Misschien update met datum uit header
            if (portaal_MeteringPoint.Portaal_Mutation != null)
            {
                DatumMutatie = DateTime.Now; //  portaal_MeteringPoint.Portaal_Mutation[0].MutationDate;
            }
