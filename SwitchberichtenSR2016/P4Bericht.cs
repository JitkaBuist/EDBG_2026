...
namespace Energie.SwitchBericht
{
    public class P4Bericht
    {
        ...
        public void P4CollectedDataBatchFromFile(string strFileName)
        {
            ...
            text = text.Replace("xmlns=" + '"' + "urn:nedu:edsn:data:p4collecteddatabatchresultresponse:1:standard" + '"', "xmlns:xsi=" + '"' + "http://www.w3.org/2001/XMLSchema-instance" + '"' + " xmlns:xsd=" + '"' + "http://www.w3.org/2001/XMLSchema" + '"');
            ...
            text = text.Replace("<Portaal_Content>", "<Portaal_Content xmlns=" + '"' + "urn:nedu:edsn:data:p4collecteddatabatchresultresponse:1:standard" + '"' + ">");
