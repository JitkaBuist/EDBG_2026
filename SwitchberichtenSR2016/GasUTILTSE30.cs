...
namespace Energie.SwitchBericht
{
    public class GasUTILTSE30
    {
        ...
        public void createUtiltsE30(int? meterstandHoog, int? meterstandLaag, string leverancierEan13Code, string netbeheerderEan13Code, long ean18Code, DateTime? meterstandOpnameNLDT, int outbox392_432MessageID, int test)
        {
            ...
            UtiltsE30Bericht.Append("UNB+UNOC:3+" + HoofdLV + ":14+");//8712423009745 pv ean
            if (test == 1)
            {
            ...
            UtiltsE30Bericht.Append("MKS+27+E01::260" + c_EOF);
            ...
            UtiltsE30Bericht.Append("PIA+5+5410000100016:::9"+ c_EOF); //code voor natural gas 
            ...
            {
                UtiltsE30Bericht.Append("QTY+220:" + meterstandHoog.ToString() + ":MTQ" + c_EOF);
                ...
                UtiltsE30Bericht.Append("STS+Z01+E01" + c_EOF); //E01 means; Volume as read
        ...
        private void Save_UtiltsE30(string MessageID, string Ean18_Nummer, int outbox392_432MessageID, int test)
        {
            ...
            cmdSaveOutbox.Parameters["@omschrijving"].Value = "Mtrstnd_G_" + Ean18_Nummer;
